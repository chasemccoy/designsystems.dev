var app = (function (exports) {
    ...
    const file = "src/components/Showcase.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			this.c = noop;
    			add_location(slot, file, 82, 5, 1521);
    			add_location(p, file, 82, 2, 1518);
    			attr_dev(div0, "class", "text");
    			add_location(div0, file, 81, 0, 1475);
    			attr_dev(div1, "class", "images");
    			add_location(div1, file, 85, 0, 1542);
    		},
